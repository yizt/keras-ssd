...
borrowed from https://github.com/yizt/keras-faster-rcnn
"""
import argparse
import sys
...
def main(args):
    ...
    for info in dataset.get_image_info_list():
        ...
        gt_boxes = info.boxes.copy()
        gt_boxes[:, 0::2] *= cfg.image_size / h
        gt_boxes[:, 1::2] *= cfg.image_size / w
    ...
    print("h:{} \nw:{}\nsize:{}".format(list(h), list(w), list(np.sqrt(h * w))))
...
if __name__ == '__main__':
    ...
    parse.add_argument("--clusters", type=int, default=6, help="cluster num")
